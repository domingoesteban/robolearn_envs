...
from robolearn_envs.robot_models.centauro.centauro_params import JOINT_NAMES
from robolearn_envs.robot_models.centauro.centauro_params import INIT_CONFIG
from robolearn_envs.robot_models.centauro.centauro_params import BODY_PARTS
from robolearn_envs.robot_models.centauro import model_path
...
class Centauro(BulletRobot):
    def __init__(self,
        ...
        elif robot_model == 'tray':
            xml_file = os.path.join(
                model_path,
                'centauro_tray.urdf'
            )
        else:
            raise ValueError('Wrong robot-model')

        super(Centauro, self).__init__(
            model_file=xml_file,
