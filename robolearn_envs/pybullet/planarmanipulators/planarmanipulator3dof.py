...
class PlanarManipulator3Dof(BulletRobot):
    def __init__(self,
        ...
        super(PlanarManipulator3Dof, self).__init__(
            model_file=xml_file,
        ...
        if init_config is not None:
            ...
            self.initial_configuration = \
                [np.deg2rad(-100), np.deg2rad(45), np.deg2rad(20)]
    ...
    def reset_robot(self, state=None):
        ...
        if self._control_mode.lower() == 'joint_position':
            ...
            for jj, joint in enumerate(self.controlled_joints):
                joint.disable_motor()
            # EFFORT_LIMITS = [5, 5, 5]  # TODO: GET THIS VALUES FROM URDF
            EFFORT_LIMITS = [20, 20, 20]  # Since 27/02 at 17.40
