...
from robolearn_envs.robot_models.walkman.walkman_params import JOINT_NAMES
from robolearn_envs.robot_models.walkman.walkman_params import INIT_CONFIG
from robolearn_envs.robot_models.walkman.walkman_params import BODY_PARTS
from robolearn_envs.robot_models.walkman import model_path
import warnings


class Walkman(BulletRobot):
    def __init__(self,
        ...
        if self_collision:
            ...
            warnings.warn("Self-collision is deactivated in WALKMAN!")

        super(Walkman, self).__init__(
            model_file=xml_file,
