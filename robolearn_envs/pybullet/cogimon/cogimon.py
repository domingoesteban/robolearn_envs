...
from robolearn_envs.robot_models.cogimon.cogimon_params import JOINT_NAMES
from robolearn_envs.robot_models.cogimon.cogimon_params import INIT_CONFIG
from robolearn_envs.robot_models.cogimon.cogimon_params import INIT_CONFIG_N_POSE
from robolearn_envs.robot_models.cogimon.cogimon_params import BODY_PARTS
from robolearn_envs.robot_models.cogimon import model_path
import warnings


class Cogimon(BulletRobot):
    def __init__(self,
        ...
        if self_collision:
            ...
            warnings.warn("Self-collision is deactivated in COGIMON!")

        super(Cogimon, self).__init__(
            model_file=xml_file,
