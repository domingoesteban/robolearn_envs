...
from robolearn_envs.robot_models.hyq.hyq_params import JOINT_NAMES
from robolearn_envs.robot_models.hyq.hyq_params import INIT_CONFIG
from robolearn_envs.robot_models.hyq.hyq_params import INIT_CONFIG_N_POSE
from robolearn_envs.robot_models.hyq.hyq_params import INIT_CONFIG_HOMING
from robolearn_envs.robot_models.hyq.hyq_params import BODY_PARTS
from robolearn_envs.robot_models.hyq import model_path


class Hyq(BulletRobot):
    def __init__(self,
                 robot_name='trunk',
                 init_config=None,
                 init_pos=None,
        ...
        if init_config is None:
            if self.init_pose_name == 'loco':
                self.initial_configuration = INIT_CONFIG
            elif self.init_pose_name == 'N':
                self.initial_configuration = INIT_CONFIG_N_POSE
            elif self.init_pose_name == 'H':
                self.initial_configuration = INIT_CONFIG_HOMING
            else:
                self.initial_configuration = INIT_CONFIG
        else:
            self.initial_configuration = init_config
    ...
    def reset_robot(self, state=None):
        ...
        # self.add_camera('kinect2_rgb_optical_frame', name='RGBCamera')
